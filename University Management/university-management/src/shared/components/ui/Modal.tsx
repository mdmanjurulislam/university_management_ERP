...
>(({ className, children, ...props }, ref) => (
  <ModalPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-full p-2 text-slate-400 hover:text-slate-900 hover:bg-slate-100 transition-all outline-none">
        <X size={18} />
